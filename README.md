...
|-------|----------|-------|
| **Standard** | [Nexen-Windows-x64-v1.4.8.exe](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Windows-x64-v1.4.8.exe) | Single-file, recommended |
| **Native AOT** | [Nexen-Windows-x64-AoT-v1.4.8.exe](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Windows-x64-AoT-v1.4.8.exe) | Faster startup |

### Linux

| Build | Download | Notes |
|-------|----------|-------|
| **AppImage x64** | [Nexen-Linux-x64-v1.4.8.AppImage](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Linux-x64-v1.4.8.AppImage) | Recommended |
| **AppImage ARM64** | [Nexen-Linux-ARM64-v1.4.8.AppImage](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Linux-ARM64-v1.4.8.AppImage) | Raspberry Pi, etc. |
| Binary x64 (clang) | [Nexen-Linux-x64-v1.4.8.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Linux-x64-v1.4.8.tar.gz) | Tarball, requires SDL2 |
| Binary x64 (gcc) | [Nexen-Linux-x64-gcc-v1.4.8.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Linux-x64-gcc-v1.4.8.tar.gz) | Tarball, requires SDL2 |
| Binary ARM64 (clang) | [Nexen-Linux-ARM64-v1.4.8.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Linux-ARM64-v1.4.8.tar.gz) | Tarball, requires SDL2 |
| Binary ARM64 (gcc) | [Nexen-Linux-ARM64-gcc-v1.4.8.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Linux-ARM64-gcc-v1.4.8.tar.gz) | Tarball, requires SDL2 |
| Native AOT x64 | [Nexen-Linux-x64-AoT-v1.4.8.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-Linux-x64-AoT-v1.4.8.tar.gz) | Faster startup |

### macOS (Apple Silicon)

| Build | Download | Notes |
|-------|----------|-------|
| **Standard** | [Nexen-macOS-ARM64-v1.4.8.zip](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.8/Nexen-macOS-ARM64-v1.4.8.zip) | App bundle |
...
> - **Download links point to v1.4.8** — Updated on each release
...
1. Download `Nexen-Windows-x64-v1.4.8.exe` from [Releases](https://github.com/TheAnsarya/Nexen/releases/tag/v1.4.8)
2. Run the executable (no installation needed)
3. **File → Open** to load a ROM

### Linux

1. Download `Nexen-Linux-x64-v1.4.8.AppImage`
2. Make executable: `chmod +x Nexen-Linux-x64-v1.4.8.AppImage`
3. Run: `./Nexen-Linux-x64-v1.4.8.AppImage`

> For non-AppImage builds, install SDL2 first: `sudo apt install libsdl2-2.0-0`

### macOS

1. Download `Nexen-macOS-ARM64-v1.4.8.zip`
