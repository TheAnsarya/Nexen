...
|-------|----------|-------|
| **Standard** | [Nexen-Windows-x64-v1.4.19.exe](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Windows-x64-v1.4.19.exe) | Single-file, recommended |
| **Native AOT** | [Nexen-Windows-x64-AoT-v1.4.19.exe](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Windows-x64-AoT-v1.4.19.exe) | Faster startup |

### Linux

| Build | Download | Notes |
|-------|----------|-------|
| **AppImage x64** | [Nexen-Linux-x64-v1.4.19.AppImage](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Linux-x64-v1.4.19.AppImage) | Recommended |
| **AppImage ARM64** | [Nexen-Linux-ARM64-v1.4.19.AppImage](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Linux-ARM64-v1.4.19.AppImage) | Raspberry Pi, etc. |
| Binary x64 (clang) | [Nexen-Linux-x64-v1.4.19.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Linux-x64-v1.4.19.tar.gz) | Tarball, requires SDL2 |
| Binary x64 (gcc) | [Nexen-Linux-x64-gcc-v1.4.19.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Linux-x64-gcc-v1.4.19.tar.gz) | Tarball, requires SDL2 |
| Binary ARM64 (clang) | [Nexen-Linux-ARM64-v1.4.19.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Linux-ARM64-v1.4.19.tar.gz) | Tarball, requires SDL2 |
| Binary ARM64 (gcc) | [Nexen-Linux-ARM64-gcc-v1.4.19.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Linux-ARM64-gcc-v1.4.19.tar.gz) | Tarball, requires SDL2 |
| Native AOT x64 | [Nexen-Linux-x64-AoT-v1.4.19.tar.gz](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Linux-x64-AoT-v1.4.19.tar.gz) | Faster startup |

### macOS (Apple Silicon)

| Build | Download | Notes |
|-------|----------|-------|
| **Standard** | [Nexen-macOS-ARM64-v1.4.19.zip](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-macOS-ARM64-v1.4.19.zip) | App bundle |
...
1. Download [Nexen-Windows-x64-v1.4.19.exe](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Windows-x64-v1.4.19.exe)
2. Run the executable (no installation needed)
3. **File → Open** to load a ROM

### Linux

1. Download [Nexen-Linux-x64-v1.4.19.AppImage](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-Linux-x64-v1.4.19.AppImage)
2. `chmod +x Nexen-Linux-x64-v1.4.19.AppImage`
3. `./Nexen-Linux-x64-v1.4.19.AppImage`

> For non-AppImage builds, install SDL2 first: `sudo apt install libsdl2-2.0-0`

### macOS

1. Download [Nexen-macOS-ARM64-v1.4.19.zip](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.19/Nexen-macOS-ARM64-v1.4.19.zip)
