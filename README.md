...
1. Download [Nexen-Windows-x64-v1.4.30.exe](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.30/Nexen-Windows-x64-v1.4.30.exe)
2. Run the executable (no installation needed)
3. **File → Open** to load a ROM

### Linux

1. Download [Nexen-Linux-x64-v1.4.30.AppImage](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.30/Nexen-Linux-x64-v1.4.30.AppImage)
2. `chmod +x Nexen-Linux-x64-v1.4.30.AppImage`
3. `./Nexen-Linux-x64-v1.4.30.AppImage`

> For non-AppImage builds, install SDL2 first: `sudo apt install libsdl2-2.0-0`

### macOS

1. Download [Nexen-macOS-ARM64-v1.4.30.zip](https://github.com/TheAnsarya/Nexen/releases/download/v1.4.30/Nexen-macOS-ARM64-v1.4.30.zip)
