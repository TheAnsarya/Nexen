...
1. Run: `c:\Users\me\source\repos\Nexen2\bin\win-x64\Release\Nexen.exe`
...
1. Open DiztinGUIsh
2. Try the Import > Nexen2 Live Stream option
3. Should connect to localhost:9998 successfully

## TROUBLESHOOTING

**Connection Refused**: Make sure step 1 is completed and server started
**Protocol Mismatch**: Check if Nexen2 has latest code compiled
**No Data**: Load and run a ROM in Nexen2 to generate trace data