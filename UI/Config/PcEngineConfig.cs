...
public sealed partial class PcEngineConfig : BaseConfig<PcEngineConfig> {
	...
	[Reactive] public partial ControllerConfig Port1A { get; set; } = new();
	[Reactive] public partial ControllerConfig Port1B { get; set; } = new();
	[Reactive] public partial ControllerConfig Port1C { get; set; } = new();
	[Reactive] public partial ControllerConfig Port1D { get; set; } = new();
	[Reactive] public partial ControllerConfig Port1E { get; set; } = new();

	[Reactive] public partial bool AllowInvalidInput { get; set; } = false;
	[Reactive] public partial bool PreventSelectRunReset { get; set; } = true;

	[Reactive] public partial PceConsoleType ConsoleType { get; set; } = PceConsoleType.Auto;
	[Reactive] public partial PceCdRomType CdRomType { get; set; } = PceCdRomType.Arcade;
	[Reactive] public partial bool EnableCdRomForHuCardGames { get; set; } = false;
	[Reactive] public partial bool DisableCdRomSaveRamForHuCardGames { get; set; } = false;
	...
	[Reactive][MinMax(0, 100)] public partial UInt32 CdAudioVolume { get; set; } = 100;
	[Reactive][MinMax(0, 100)] public partial UInt32 AdpcmVolume { get; set; } = 100;
	[Reactive] public partial bool UseHuC6280aAudio { get; set; } = true;

	[Reactive] public partial bool RemoveSpriteLimit { get; set; } = false;
	[Reactive] public partial bool DisableSprites { get; set; } = false;
	[Reactive] public partial bool DisableSpritesVdc2 { get; set; } = false;
	[Reactive] public partial bool DisableBackground { get; set; } = false;
	[Reactive] public partial bool DisableBackgroundVdc2 { get; set; } = false;
	...
	[Reactive] public partial OverscanConfig Overscan { get; set; } = new() { Top = 3, Left = 18, Right = 18 };

	[Reactive] public partial UInt32[] Palette { get; set; } = PcEngineConfig.DefaultPalette.ToArray();
