...
public sealed partial class SnesConfig : BaseConfig<SnesConfig> {
	[Reactive] public partial ConsoleOverrideConfig ConfigOverrides { get; set; } = new();

	//Input
	[Reactive] public partial SnesControllerConfig Port1 { get; set; } = new SnesControllerConfig();
	[Reactive] public partial SnesControllerConfig Port2 { get; set; } = new SnesControllerConfig();

	[Reactive] public partial SnesControllerConfig Port1A { get; set; } = new SnesControllerConfig();
	[Reactive] public partial SnesControllerConfig Port1B { get; set; } = new SnesControllerConfig();
	[Reactive] public partial SnesControllerConfig Port1C { get; set; } = new SnesControllerConfig();
	[Reactive] public partial SnesControllerConfig Port1D { get; set; } = new SnesControllerConfig();

	[Reactive] public partial SnesControllerConfig Port2A { get; set; } = new SnesControllerConfig();
	[Reactive] public partial SnesControllerConfig Port2B { get; set; } = new SnesControllerConfig();
	[Reactive] public partial SnesControllerConfig Port2C { get; set; } = new SnesControllerConfig();
	[Reactive] public partial SnesControllerConfig Port2D { get; set; } = new SnesControllerConfig();
	...
	//Video
	[Reactive] public partial bool BlendHighResolutionModes { get; set; } = false;
	...
	[Reactive] public partial bool HideSprites { get; set; } = false;
	[Reactive] public partial bool DisableFrameSkipping { get; set; } = false;
	[Reactive] public partial bool ForceFixedResolution { get; set; } = false;

	[Reactive] public partial OverscanConfig Overscan { get; set; } = new() { Top = 7, Bottom = 8 };

	//Audio
	[Reactive] public partial DspInterpolationType InterpolationType { get; set; } = DspInterpolationType.Gauss;
	...
	[Reactive][MinMax(0, 100)] public partial UInt32 Channel6Vol { get; set; } = 100;
	[Reactive][MinMax(0, 100)] public partial UInt32 Channel7Vol { get; set; } = 100;
	[Reactive][MinMax(0, 100)] public partial UInt32 Channel8Vol { get; set; } = 100;

	//Emulation
	[Reactive] public partial bool EnableRandomPowerOnState { get; set; } = false;
	[Reactive] public partial bool EnableStrictBoardMappings { get; set; } = false;
	[Reactive] public partial RamState RamPowerOnState { get; set; } = RamState.Random;
	[Reactive][MinMax(-999, 999)] public partial Int32 SpcClockSpeedAdjustment { get; set; } = 40;
	...
	[Reactive][MinMax(100, 1000)] public partial UInt32 GsuClockSpeed { get; set; } = 100;

	//BSX
	[Reactive] public partial bool BsxUseCustomTime { get; set; } = false;
	[Reactive] public partial DateTimeOffset BsxCustomDate { get; set; } = new DateTimeOffset(1995, 1, 1, 0, 0, 0, TimeSpan.Zero);
	[Reactive] public partial TimeSpan BsxCustomTime { get; set; } = TimeSpan.Zero;
