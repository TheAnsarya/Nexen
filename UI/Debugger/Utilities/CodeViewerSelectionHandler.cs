...
public sealed class CodeViewerSelectionHandler : IDisposable {
	...
	public bool IsMarginClick { get; private set; } = false;
	...
	public void Viewer_CodePointerMoved(DisassemblyViewer sender, CodePointerMovedEventArgs e) {
		...
		if (!IsMarginClick && GetAddress(e) >= 0 && e.PointerEvent.GetCurrentPoint(null).Properties.IsLeftButtonPressed) {
			_model.ResizeSelectionTo(GetAddress(e));
		}
	}
