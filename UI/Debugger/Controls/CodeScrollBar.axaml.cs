...
public partial class CodeScrollBar : UserControl {
	...
	public CodeScrollBar() {
		...
		_panel.AddHandler(Panel.PointerPressedEvent, (s, e) => ScrollToPosition(e.GetPosition(_panel)), RoutingStrategies.Bubble, true);
	...
	private void UpdatePosition() {
		if (Maximum > 0) {
			...
			if (margin < 0) {
				...
				_thumb.Height = margin + 20 > _panel.Bounds.Height ? _panel.Bounds.Height - margin : 20;
			}
