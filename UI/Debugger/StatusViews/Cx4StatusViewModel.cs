...
public sealed partial class Cx4StatusViewModel : BaseConsoleStatusViewModel {
	...
	[Reactive] public partial UInt16 RegPb { get; set; }
	[Reactive] public partial UInt16 RegP { get; set; }
	[Reactive] public partial byte RegPc { get; set; }
	[Reactive] public partial byte RegSp { get; set; }

	[Reactive] public partial UInt32 RegMdr { get; set; }
	[Reactive] public partial UInt32 RegMar { get; set; }
	[Reactive] public partial UInt32 RegDpr { get; set; }

	[Reactive] public partial UInt32 RegA { get; set; }
	[Reactive] public partial UInt64 RegMult { get; set; }

	[Reactive] public partial UInt32 RomBuffer { get; set; }
	[Reactive] public partial UInt32 RamBuffer { get; set; }
