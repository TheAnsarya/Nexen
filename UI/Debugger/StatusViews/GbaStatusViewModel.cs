...
public sealed partial class GbaStatusViewModel : BaseConsoleStatusViewModel {
	...
	[Reactive] public partial GbaCpuMode Mode { get; set; }
	[Reactive] public partial string ModeString { get; set; } = GbaCpuMode.User.ToString();
