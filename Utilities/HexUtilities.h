...
public:
	...
	[[nodiscard]] static string ToHex(uint8_t value);
	...
	/// </remarks>
	[[nodiscard]] static const char* ToHexChar(uint8_t value);
	...
	[[nodiscard]] static string ToHex(uint16_t value);
	...
	[[nodiscard]] static string ToHex(uint32_t value, bool fullSize = false);
	...
	[[nodiscard]] static string ToHex(int32_t value, bool fullSize = false);
	...
	[[nodiscard]] static string ToHex20(uint32_t value);
	...
	[[nodiscard]] static string ToHex24(int32_t value);
	...
	[[nodiscard]] static string ToHex32(uint32_t value);
	...
	[[nodiscard]] static string ToHex(uint64_t value);
	...
	[[nodiscard]] static string ToHex(vector<uint8_t>& data, char delimiter = 0);
	...
	/// <remarks>Handles both "FF" and "0xFF" formats. Uses constexpr nibble lookup table.</remarks>
	[[nodiscard]] static int FromHex(string_view hex);
};
