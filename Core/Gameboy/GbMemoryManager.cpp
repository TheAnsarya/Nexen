		...
		if (addr == 0xFFFF) {
			...
			if (_gameboy->IsCgb()) {
				switch (addr) {
					...
					case 0xFF70:
						return _ppu->IsCgbEnabled() ? (_state.CgbWorkRamBank | 0xF8) : 0xFF;
					case 0xFF72:
						return _state.CgbRegFF72;
					case 0xFF73:
						return _state.CgbRegFF73;
			...
			switch (addr) {
				...
				case 0xFF01:
					return _state.SerialData; // SB - Serial transfer data (R/W)
				case 0xFF02:
					return _state.SerialControl | (_gameboy->IsCgb() ? 0x7C : 0x7E); // SC - Serial Transfer Control (R/W)
				...
				case 0xFF0F:
					return _state.IrqRequests | 0xE0; // IF - Interrupt flags (R/W)
		...
		if (addr == 0xFFFF) {
			...
			if (addr == 0xFF50) {
				...
				switch (addr) {
					...
					case 0xFF72:
						_state.CgbRegFF72 = value;
						break;
					case 0xFF73:
						_state.CgbRegFF73 = value;
						break;
					case 0xFF74:
						if (_ppu->IsCgbEnabled()) {
