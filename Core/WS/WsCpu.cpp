...
void WsCpu::LdsLesLeaModRm() {
	if (_modRm.Mode == 3) {
		...
		switch (_modRm.Rm) {
			default:
			case 0x00:
				offset = _state.BX + _state.AX;
				break;
			case 0x01:
				offset = _state.BX + _state.CX;
				break;
			case 0x02:
...
void WsCpu::Grp2ModRm() {
	...
	switch (_modRm.Register) {
		default:
		case 0x00:
			result = ROL(param, shift);
			break;
		case 0x01:
			result = ROR(param, shift);
			break;
		case 0x02:
			result = RCL(param, shift);
			break;
		case 0x03:
			result = RCR(param, shift);
			break;
		case 0x04:
			result = SHL(param, shift);
			break;
		case 0x05:
			result = SHR(param, shift);
			break;
		case 0x06:
			result = 0;
			break;
		case 0x07:
			result = SAR(param, shift);
			break;
	}
	SetModRm(result);
}
...
T WsCpu::GetAluResult(AluOp op, T param1, T param2) {
	switch (op) {
		default:
		case AluOp::Add:
			return Add<T>(param1, param2, 0);
		case AluOp::Or:
			return Or<T>(param1, param2);
		case AluOp::Adc:
			return Add<T>(param1, param2, _state.Flags.Carry);
		case AluOp::Sbb:
			return Sub<T>(param1, param2, _state.Flags.Carry);
		case AluOp::And:
			return And<T>(param1, param2);
		case AluOp::Sub:
			return Sub<T>(param1, param2, 0);
		case AluOp::Xor:
			return Xor<T>(param1, param2);
		case AluOp::Cmp:
			return Sub<T>(param1, param2, 0);
	}
}
...
start:
	...
	switch (opCode) {
		case 0x00:
			ProcessAluModRm<AluOp::Add, false, uint8_t>();
			break;
		case 0x01:
			ProcessAluModRm<AluOp::Add, false, uint16_t>();
			break;
		case 0x02:
			ProcessAluModRm<AluOp::Add, true, uint8_t>();
			break;
		case 0x03:
			ProcessAluModRm<AluOp::Add, true, uint16_t>();
			break;
		case 0x04:
			ProcessAluImm<AluOp::Add, uint8_t>();
			break;
		case 0x05:
			ProcessAluImm<AluOp::Add, uint16_t>();
			break;
		case 0x06:
			PushSegment(_state.ES);
			break;
		case 0x07:
			PopSegment(_state.ES);
			break;
		case 0x08:
			ProcessAluModRm<AluOp::Or, false, uint8_t>();
			break;
		case 0x09:
			ProcessAluModRm<AluOp::Or, false, uint16_t>();
			break;
		case 0x0A:
			ProcessAluModRm<AluOp::Or, true, uint8_t>();
			break;
		case 0x0B:
			ProcessAluModRm<AluOp::Or, true, uint16_t>();
			break;
		case 0x0C:
			ProcessAluImm<AluOp::Or, uint8_t>();
			break;
		case 0x0D:
			ProcessAluImm<AluOp::Or, uint16_t>();
			break;
		case 0x0E:
			PushSegment(_state.CS);
			break;
		case 0x0F:
			Undefined();
			break;
		...
		case 0x10:
			ProcessAluModRm<AluOp::Adc, false, uint8_t>();
			break;
		case 0x11:
			ProcessAluModRm<AluOp::Adc, false, uint16_t>();
			break;
		case 0x12:
			ProcessAluModRm<AluOp::Adc, true, uint8_t>();
			break;
		case 0x13:
			ProcessAluModRm<AluOp::Adc, true, uint16_t>();
			break;
		case 0x14:
			ProcessAluImm<AluOp::Adc, uint8_t>();
			break;
		case 0x15:
			ProcessAluImm<AluOp::Adc, uint16_t>();
			break;
		case 0x16:
			PushSegment(_state.SS);
			break;
		case 0x17:
			...
			break;
		case 0x18:
			ProcessAluModRm<AluOp::Sbb, false, uint8_t>();
			break;
		case 0x19:
			ProcessAluModRm<AluOp::Sbb, false, uint16_t>();
			break;
		case 0x1A:
			ProcessAluModRm<AluOp::Sbb, true, uint8_t>();
			break;
		case 0x1B:
			ProcessAluModRm<AluOp::Sbb, true, uint16_t>();
			break;
		case 0x1C:
			ProcessAluImm<AluOp::Sbb, uint8_t>();
			break;
		case 0x1D:
			ProcessAluImm<AluOp::Sbb, uint16_t>();
			break;
		case 0x1E:
			PushSegment(_state.DS);
			break;
		case 0x1F:
			PopSegment(_state.DS);
			break;

		case 0x20:
			ProcessAluModRm<AluOp::And, false, uint8_t>();
			break;
		case 0x21:
			ProcessAluModRm<AluOp::And, false, uint16_t>();
			break;
		case 0x22:
			ProcessAluModRm<AluOp::And, true, uint8_t>();
			break;
		case 0x23:
			ProcessAluModRm<AluOp::And, true, uint16_t>();
			break;
		case 0x24:
			ProcessAluImm<AluOp::And, uint8_t>();
			break;
		case 0x25:
			ProcessAluImm<AluOp::And, uint16_t>();
			break;
		case 0x26:
		...
		case 0x27:
			...
			break;
		case 0x28:
			ProcessAluModRm<AluOp::Sub, false, uint8_t>();
			break;
		case 0x29:
			ProcessAluModRm<AluOp::Sub, false, uint16_t>();
			break;
		case 0x2A:
			ProcessAluModRm<AluOp::Sub, true, uint8_t>();
			break;
		case 0x2B:
			ProcessAluModRm<AluOp::Sub, true, uint16_t>();
			break;
		case 0x2C:
			ProcessAluImm<AluOp::Sub, uint8_t>();
			break;
		case 0x2D:
			ProcessAluImm<AluOp::Sub, uint16_t>();
			break;
		case 0x2E:
		...
		case 0x30:
			ProcessAluModRm<AluOp::Xor, false, uint8_t>();
			break;
		case 0x31:
			ProcessAluModRm<AluOp::Xor, false, uint16_t>();
			break;
		case 0x32:
			ProcessAluModRm<AluOp::Xor, true, uint8_t>();
			break;
		case 0x33:
			ProcessAluModRm<AluOp::Xor, true, uint16_t>();
			break;
		case 0x34:
			ProcessAluImm<AluOp::Xor, uint8_t>();
			break;
		case 0x35:
			ProcessAluImm<AluOp::Xor, uint16_t>();
			break;
		case 0x36:
		...
		case 0x37:
			...
			break;
		case 0x38:
			ProcessAluModRm<AluOp::Cmp, false, uint8_t>();
			break;
		case 0x39:
			ProcessAluModRm<AluOp::Cmp, false, uint16_t>();
			break;
		case 0x3A:
			ProcessAluModRm<AluOp::Cmp, true, uint8_t>();
			break;
		case 0x3B:
			ProcessAluModRm<AluOp::Cmp, true, uint16_t>();
			break;
		case 0x3C:
			ProcessAluImm<AluOp::Cmp, uint8_t>();
			break;
		case 0x3D:
			ProcessAluImm<AluOp::Cmp, uint16_t>();
			break;
		case 0x3E:
		...
		case 0x68:
			...
			break;
		case 0x69:
			MultSignedModRm<uint16_t>();
			break;
		case 0x6A:
			Push((int16_t)(int8_t)ReadCodeByte());
			break;
		case 0x6B:
			MultSignedModRm<uint8_t>();
			break;
		case 0x6C:
			INS<uint8_t>();
			break;
		...
		case 0x70:
			Jump(_state.Flags.Overflow);
			break;
		case 0x71:
			Jump(!_state.Flags.Overflow);
			break;
		case 0x72:
			Jump(_state.Flags.Carry);
			break;
		case 0x73:
			Jump(!_state.Flags.Carry);
			break;
		case 0x74:
			Jump(_state.Flags.Zero);
			break;
		case 0x75:
			Jump(!_state.Flags.Zero);
			break;
		case 0x76:
			Jump(_state.Flags.Carry || _state.Flags.Zero);
			break;
		case 0x77:
			Jump(!_state.Flags.Carry && !_state.Flags.Zero);
			break;
		case 0x78:
			Jump(_state.Flags.Sign);
			break;
		case 0x79:
			Jump(!_state.Flags.Sign);
			break;
		case 0x7A:
			Jump(_state.Flags.Parity);
			break;
		case 0x7B:
			Jump(!_state.Flags.Parity);
			break;
		case 0x7C:
			Jump(_state.Flags.Sign != _state.Flags.Overflow);
			break;
		case 0x7D:
			Jump(_state.Flags.Sign == _state.Flags.Overflow);
			break;
		case 0x7E:
			Jump(_state.Flags.Sign != _state.Flags.Overflow || _state.Flags.Zero);
			break;
		case 0x7F:
			Jump(_state.Flags.Sign == _state.Flags.Overflow && !_state.Flags.Zero);
			break;
		...
		case 0x80:
			Grp1ModRm<false, uint8_t>();
			break;
		case 0x81:
			Grp1ModRm<false, uint16_t>();
			break;
		case 0x82:
			Grp1ModRm<true, uint8_t>();
			break;
		case 0x83:
			Grp1ModRm<true, uint16_t>();
			break;
		case 0x84:
			TestModRm<uint8_t>();
			break;
		case 0x85:
			...
			break;
		case 0x86:
			ExchangeModRm<uint8_t>();
			break;
		case 0x87:
			ExchangeModRm<uint16_t>();
			break;
		case 0x88:
			MoveModRm<false, uint8_t>();
			break;
		case 0x89:
			MoveModRm<false, uint16_t>();
			break;
		case 0x8A:
			MoveModRm<true, uint8_t>();
			break;
		case 0x8B:
			MoveModRm<true, uint16_t>();
			break;
		case 0x8C:
			MoveSegment<false>();
			break;
		...
		case 0x90:
			...
			break;
		case 0x91:
			Exchange(_state.CX, _state.AX);
			break;
		case 0x92:
			Exchange(_state.DX, _state.AX);
			break;
		case 0x93:
			Exchange(_state.BX, _state.AX);
			break;
		case 0x94:
			Exchange(_state.SP, _state.AX);
			break;
		case 0x95:
			Exchange(_state.BP, _state.AX);
			break;
		case 0x96:
			Exchange(_state.SI, _state.AX);
			break;
		case 0x97:
			Exchange(_state.DI, _state.AX);
			break;
		case 0x98:
			CBW();
			break;
		...
		case 0xA0:
			MoveAccumulator<false, uint8_t>();
			break;
		case 0xA1:
			MoveAccumulator<false, uint16_t>();
			break;
		case 0xA2:
			MoveAccumulator<true, uint8_t>();
			break;
		case 0xA3:
			MoveAccumulator<true, uint16_t>();
			break;
		case 0xA4:
			MOVS<uint8_t>();
			break;
		...
		case 0xA7:
			...
			break;
		case 0xA8:
			TestImmediate<uint8_t>();
			break;
		case 0xA9:
			TestImmediate<uint16_t>();
			break;
		case 0xAA:
			STOS<uint8_t>();
			break;
		...
		case 0xB0:
			MoveLo(_state.AX, ReadCodeByte());
			break;
		case 0xB1:
			MoveLo(_state.CX, ReadCodeByte());
			break;
		case 0xB2:
			MoveLo(_state.DX, ReadCodeByte());
			break;
		case 0xB3:
			MoveLo(_state.BX, ReadCodeByte());
			break;
		case 0xB4:
			MoveHi(_state.AX, ReadCodeByte());
			break;
		case 0xB5:
			MoveHi(_state.CX, ReadCodeByte());
			break;
		case 0xB6:
			MoveHi(_state.DX, ReadCodeByte());
			break;
		case 0xB7:
			MoveHi(_state.BX, ReadCodeByte());
			break;
		case 0xB8:
			Move(_state.AX, ReadCodeWord());
			break;
		case 0xB9:
			Move(_state.CX, ReadCodeWord());
			break;
		case 0xBA:
			Move(_state.DX, ReadCodeWord());
			break;
		case 0xBB:
			Move(_state.BX, ReadCodeWord());
			break;
		case 0xBC:
			Move(_state.SP, ReadCodeWord());
			break;
		case 0xBD:
			Move(_state.BP, ReadCodeWord());
			break;
		case 0xBE:
			Move(_state.SI, ReadCodeWord());
			break;
		case 0xBF:
			Move(_state.DI, ReadCodeWord());
			break;

		case 0xC0:
			Grp2ModRm<uint8_t, Grp2Mode::Immediate>();
			break;
		case 0xC1:
			Grp2ModRm<uint16_t, Grp2Mode::Immediate>();
			break;
		case 0xC2:
			RetImm();
			break;
		...
		case 0xC5:
			...
			break;
		case 0xC6:
			MoveImmediate<uint8_t>();
			break;
		case 0xC7:
			MoveImmediate<uint16_t>();
			break;
		case 0xC8:
			Enter();
			break;
		...
		case 0xD0:
			Grp2ModRm<uint8_t, Grp2Mode::One>();
			break;
		case 0xD1:
			Grp2ModRm<uint16_t, Grp2Mode::One>();
			break;
		case 0xD2:
			Grp2ModRm<uint8_t, Grp2Mode::CL>();
			break;
		case 0xD3:
			Grp2ModRm<uint16_t, Grp2Mode::CL>();
			break;
		case 0xD4:
			AAM();
			break;
		...
		case 0xE3:
			...
			break;
		case 0xE4:
			InStoreAx<uint8_t, false>(ReadCodeByte());
			break;
		case 0xE5:
			InStoreAx<uint16_t, false>(ReadCodeByte());
			break;
		case 0xE6:
			Out<uint8_t, 6>(ReadCodeByte(), _state.AX);
			break;
		case 0xE7:
			Out<uint16_t, 6>(ReadCodeByte(), _state.AX);
			break;
		case 0xE8:
			CallNearWord();
			break;
		...
		case 0xEB:
			...
			break;
		case 0xEC:
			InStoreAx<uint8_t, true>(_state.DX);
			break;
		case 0xED:
			InStoreAx<uint16_t, true>(_state.DX);
			break;
		case 0xEE:
			Out<uint8_t, 4>(_state.DX, _state.AX);
			break;
		case 0xEF:
			Out<uint16_t, 4>(_state.DX, _state.AX);
			break;
		...
		case 0xF4:
			...
			break;
		case 0xF5:
			SetFlagValue(_state.Flags.Carry, !_state.Flags.Carry);
			break; // CMC
		case 0xF6:
			Grp3ModRm<uint8_t>();
			break;
		case 0xF7:
			...
			break;
		case 0xF8:
			SetFlagValue(_state.Flags.Carry, false);
			break; // CLC
		case 0xF9:
			SetFlagValue(_state.Flags.Carry, true);
			break; // STC
		case 0xFA:
			SetFlagValue(_state.Flags.Irq, false);
			break; // CLI
		case 0xFB:
			SetIrqFlag();
			break; // STI
		case 0xFC:
			SetFlagValue(_state.Flags.Direction, false);
			break; // CLD
		case 0xFD:
			SetFlagValue(_state.Flags.Direction, true);
			break; // STD
		case 0xFE:
			Grp45ModRm<uint8_t>();
			break;
