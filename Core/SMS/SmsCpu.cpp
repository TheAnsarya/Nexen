...
void SmsCpu::ExecOpCode(uint8_t opCode) {
	...
	switch (opCode) {
		case 0x00:
			...
			break;
		case 0x01:
			LD(_regBC, ReadCodeWord());
			break;
		case 0x02:
			LD_Indirect_A(_regBC);
			break;
		case 0x03:
			INC(_regBC);
			break;
		...
		case 0x10:
			...
			break;
		case 0x11:
			LD(_regDE, ReadCodeWord());
			break;
		case 0x12:
			LD_Indirect_A(_regDE);
			break;
		case 0x13:
			INC(_regDE);
			break;
		...
		case 0x1D:
			...
			break;
		case 0x1E:
			LD(_state.E, ReadCode());
			break;
		case 0x1F:
			RRA();
			break;
		case 0x20:
			JR((_state.Flags & SmsCpuFlags::Zero) == 0, ReadCode());
			break;
		case 0x21:
			LD(getHl(), ReadCodeWord());
			break;
		case 0x22:
			LD_Indirect16(ReadCodeWord(), getHl());
			break;
		case 0x23:
			INC(getHl());
			break;
		...
		case 0x29:
			...
			break;
		case 0x2A:
			LDReg_Indirect16(getHl(), ReadCodeWord());
			break;
		case 0x2B:
			DEC(getHl());
			break;
		...
		case 0x2F:
			...
			break;
		case 0x30:
			JR((_state.Flags & SmsCpuFlags::Carry) == 0, ReadCode());
			break;
		case 0x31:
			LD(_state.SP, ReadCodeWord());
			break;
		case 0x32:
			LD_Indirect_A(ReadCodeWord());
			break;
		case 0x33:
			INC_SP();
			break;
		case 0x34:
			INC_Indirect(getIndirectHl());
			break;
		case 0x35:
			DEC_Indirect(getIndirectHl());
			break;
		case 0x36:
			LD_IndirectImm(getIndirectHl());
			break;
		case 0x37:
			SCF();
			break;
		...
		case 0x3D:
			...
			break;
		case 0x3E:
			LD(_state.A, ReadCode());
			break;
		case 0x3F:
			CCF();
			break;
		case 0x40:
			LD(_state.B, _state.B);
			break;
		case 0x41:
			LD(_state.B, _state.C);
			break;
		case 0x42:
			LD(_state.B, _state.D);
			break;
		case 0x43:
			LD(_state.B, _state.E);
			break;
		case 0x44:
			LD(_state.B, getH());
			break;
		case 0x45:
			...
			break;
		case 0x46:
			LD(_state.B, Read(getIndirectHl()));
			break;
		case 0x47:
			LD(_state.B, _state.A);
			break;
		case 0x48:
			LD(_state.C, _state.B);
			break;
		case 0x49:
			LD(_state.C, _state.C);
			break;
		case 0x4A:
			LD(_state.C, _state.D);
			break;
		case 0x4B:
			LD(_state.C, _state.E);
			break;
		case 0x4C:
			LD(_state.C, getH());
			break;
		case 0x4D:
			...
			break;
		case 0x4E:
			LD(_state.C, Read(getIndirectHl()));
			break;
		case 0x4F:
			LD(_state.C, _state.A);
			break;
		case 0x50:
			LD(_state.D, _state.B);
			break;
		case 0x51:
			LD(_state.D, _state.C);
			break;
		case 0x52:
			LD(_state.D, _state.D);
			break;
		case 0x53:
			LD(_state.D, _state.E);
			break;
		case 0x54:
			LD(_state.D, getH());
			break;
		case 0x55:
			...
			break;
		case 0x56:
			LD(_state.D, Read(getIndirectHl()));
			break;
		case 0x57:
			LD(_state.D, _state.A);
			break;
		case 0x58:
			LD(_state.E, _state.B);
			break;
		case 0x59:
			LD(_state.E, _state.C);
			break;
		case 0x5A:
			LD(_state.E, _state.D);
			break;
		case 0x5B:
			LD(_state.E, _state.E);
			break;
		case 0x5C:
			LD(_state.E, getH());
			break;
		case 0x5D:
			...
			break;
		case 0x5E:
			LD(_state.E, Read(getIndirectHl()));
			break;
		case 0x5F:
			LD(_state.E, _state.A);
			break;
		case 0x60:
			LD(getH(), _state.B);
			break;
		...
		case 0x65:
			...
			break;
		case 0x66:
			LD(_state.H, Read(getIndirectHl()));
			break;
		case 0x67:
			LD(getH(), _state.A);
			break;
		...
		case 0x6D:
			...
			break;
		case 0x6E:
			LD(_state.L, Read(getIndirectHl()));
			break;
		case 0x6F:
			LD(getL(), _state.A);
			break;
		case 0x70:
			LD_Indirect(getIndirectHl(), _state.B);
			break;
		case 0x71:
			LD_Indirect(getIndirectHl(), _state.C);
			break;
		case 0x72:
			LD_Indirect(getIndirectHl(), _state.D);
			break;
		case 0x73:
			LD_Indirect(getIndirectHl(), _state.E);
			break;
		case 0x74:
			LD_Indirect(getIndirectHl(), _state.H);
			break;
		case 0x75:
			LD_Indirect(getIndirectHl(), _state.L);
			break;
		case 0x76:
			HALT();
			break;
		case 0x77:
			LD_Indirect(getIndirectHl(), _state.A);
			break;
		case 0x78:
			LD(_state.A, _state.B);
			break;
		case 0x79:
			LD(_state.A, _state.C);
			break;
		case 0x7A:
			LD(_state.A, _state.D);
			break;
		case 0x7B:
			LD(_state.A, _state.E);
			break;
		case 0x7C:
			LD(_state.A, getH());
			break;
		case 0x7D:
			...
			break;
		case 0x7E:
			LD(_state.A, Read(getIndirectHl()));
			break;
		case 0x7F:
			LD(_state.A, _state.A);
			break;
		case 0x80:
			ADD(_state.B);
			break;
		...
		case 0xBD:
			...
			break;
		case 0xBE:
			CP(Read(getIndirectHl()));
			break;
		case 0xBF:
			CP(_state.A);
			break;
		case 0xC0:
			RET((_state.Flags & SmsCpuFlags::Zero) == 0);
			break;
		case 0xC1:
			POP(_regBC);
			break;
		case 0xC2:
			JP((_state.Flags & SmsCpuFlags::Zero) == 0, ReadCodeWord());
			break;
		case 0xC3:
			JP(ReadCodeWord());
			break;
		case 0xC4:
			CALL((_state.Flags & SmsCpuFlags::Zero) == 0, ReadCodeWord());
			break;
		case 0xC5:
			PUSH(_regBC);
			break;
		...
		case 0xCF:
			...
			break;
		case 0xD0:
			RET((_state.Flags & SmsCpuFlags::Carry) == 0);
			break;
		case 0xD1:
			POP(_regDE);
			break;
		case 0xD2:
			JP((_state.Flags & SmsCpuFlags::Carry) == 0, ReadCodeWord());
			break;
		case 0xD3:
			OUT_Imm(ReadCode());
			break;
		case 0xD4:
			CALL((_state.Flags & SmsCpuFlags::Carry) == 0, ReadCodeWord());
			break;
		case 0xD5:
			PUSH(_regDE);
			break;
		...
		case 0xDC:
			...
			break;
		case 0xDD:
			ExecOpCode<0xDD>(ReadNextOpCode());
			break;
		case 0xDE:
			SBC(ReadCode());
			break;
		case 0xDF:
			...
			break;
		case 0xE0:
			RET((_state.Flags & SmsCpuFlags::Parity) == 0);
			break;
		case 0xE1:
			POP(getHl());
			break;
		case 0xE2:
			JP((_state.Flags & SmsCpuFlags::Parity) == 0, ReadCodeWord());
			break;
		case 0xE3:
			ExchangeSp(getHl());
			break;
		case 0xE4:
			CALL((_state.Flags & SmsCpuFlags::Parity) == 0, ReadCodeWord());
			break;
		case 0xE5:
			PUSH(getHl());
			break;
		...
		case 0xEF:
			...
			break;
		case 0xF0:
			RET((_state.Flags & SmsCpuFlags::Sign) == 0);
			break;
		case 0xF1:
			POP_AF();
			break;
		case 0xF2:
			JP((_state.Flags & SmsCpuFlags::Sign) == 0, ReadCodeWord());
			break;
		case 0xF3:
			DI();
			break;
		case 0xF4:
			CALL((_state.Flags & SmsCpuFlags::Sign) == 0, ReadCodeWord());
			break;
		case 0xF5:
			PUSH(_regAF);
			break;
		...
		case 0xFC:
			...
			break;
		case 0xFD:
			ExecOpCode<0xFD>(ReadNextOpCode());
			break;
		case 0xFE:
			CP(ReadCode());
			break;
...
void SmsCpu::PREFIX_ED() {
	switch (ReadNextOpCode()) {
		case 0x40:
			IN(_state.B, _state.C);
			break;
		case 0x41:
			OUT(_state.B, _state.C);
			break;
		case 0x42:
			SBC16(_regBC);
			break;
		case 0x43:
			LD_Indirect16(ReadCodeWord(), _regBC);
			break;
		case 0x44:
			NEG();
			break;
		...
		case 0x47:
			...
			break;
		case 0x48:
			IN(_state.C, _state.C);
			break;
		case 0x49:
			OUT(_state.C, _state.C);
			break;
		case 0x4A:
			ADC16(_regBC);
			break;
		case 0x4B:
			LDReg_Indirect16(_regBC, ReadCodeWord());
			break;
		case 0x4C:
			NEG();
			break;
		...
		case 0x4F:
			...
			break;
		case 0x50:
			IN(_state.D, _state.C);
			break;
		case 0x51:
			OUT(_state.D, _state.C);
			break;
		case 0x52:
			SBC16(_regDE);
			break;
		case 0x53:
			LD_Indirect16(ReadCodeWord(), _regDE);
			break;
		case 0x54:
			NEG();
			break;
		...
		case 0x56:
			...
			break;
		case 0x57:
			LD_IR(_state.A, _state.I);
			break;
		case 0x58:
			IN(_state.E, _state.C);
			break;
		case 0x59:
			OUT(_state.E, _state.C);
			break;
		case 0x5A:
			ADC16(_regDE);
			break;
		case 0x5B:
			LDReg_Indirect16(_regDE, ReadCodeWord());
			break;
		case 0x5C:
			NEG();
			break;
		...
		case 0x5E:
			...
			break;
		case 0x5F:
			LD_IR(_state.A, _state.R);
			break;
		case 0x60:
			IN(_state.H, _state.C);
			break;
		case 0x61:
			OUT(_state.H, _state.C);
			break;
		case 0x62:
			SBC16(_regHL);
			break;
		case 0x63:
			LD_Indirect16(ReadCodeWord(), _regHL);
			break;
		case 0x64:
			NEG();
			break;
		...
		case 0x67:
			...
			break;
		case 0x68:
			IN(_state.L, _state.C);
			break;
		case 0x69:
			OUT(_state.L, _state.C);
			break;
		case 0x6A:
			ADC16(_regHL);
			break;
		case 0x6B:
			LDReg_Indirect16(_regHL, ReadCodeWord());
			break;
		case 0x6C:
			NEG();
			break;
		...
		case 0x72:
			...
			break;
		case 0x73:
			LD_Indirect16(ReadCodeWord(), _state.SP);
			break;
		case 0x74:
			NEG();
			break;
		...
		case 0x77:
			break; // NOP
		case 0x78:
			IN(_state.A, _state.C);
			break;
		case 0x79:
			OUT(_state.A, _state.C);
			break;
		case 0x7A:
			ADC16(_state.SP);
			break;
		case 0x7B:
			LDReg_Indirect16(_state.SP, ReadCodeWord());
			break;
		case 0x7C:
			NEG();
			break;
...
void SmsCpu::PREFIX_CB() {
	switch (prefix) {
		default:
			...
			break;
		case 0xDD:
			_state.WZ = _cbAddress = (uint16_t)(_regIX + (int8_t)ReadCode());
			break;
		case 0xFD:
			_state.WZ = _cbAddress = (uint16_t)(_regIY + (int8_t)ReadCode());
			break;
	}
