...
uint8_t GbaApu::ReadRegister(uint32_t addr) {
	switch (addr) {
		case 0x60:
			return _square1->Read(0);
		case 0x61:
			return 0;
		case 0x62:
			return _square1->Read(1);
		case 0x63:
			return _square1->Read(2);
		case 0x64:
			return _square1->Read(3);
		case 0x65:
			return _square1->Read(4);
		case 0x66:
			return 0;
		case 0x67:
			return 0;
		...
		case 0x68:
			return _square2->Read(1);
		case 0x69:
			return _square2->Read(2);
		case 0x6A:
			return 0;
		case 0x6B:
			return 0;
		case 0x6C:
			return _square2->Read(3);
		case 0x6D:
			return _square2->Read(4);
		case 0x6E:
			return 0;
		case 0x6F:
			return 0;
		...
		case 0x78:
			return _noise->Read(1);
		case 0x79:
			return _noise->Read(2);
		case 0x7A:
			return 0;
		case 0x7B:
			return 0;
		case 0x7C:
			return _noise->Read(3);
		case 0x7D:
			return _noise->Read(4);
		case 0x7E:
			return 0;
		case 0x7F:
			return 0;
		...
		case 0x80:
			return _state.RightVolume | (_state.LeftVolume << 4);
		case 0x81:
			return _state.EnabledGb;

		case 0x82:
			return _state.VolumeControl;
		case 0x83:
			return _state.DmaSoundControl;
		...
		case 0x88:
			return (uint8_t)_state.Bias;
		case 0x89:
			return (uint8_t)(_state.Bias >> 8) | (_state.SamplingRate << 6);
		case 0x8A:
			return 0;
		case 0x8B:
			return 0;
...
void GbaApu::WriteRegister(GbaAccessModeVal mode, uint32_t addr, uint8_t value) {
	...
	switch (addr) {
		case 0x60:
			_square1->Write(0, value);
			break;
		case 0x61:
			break;
		case 0x62:
			_square1->Write(1, value);
			break;
		case 0x63:
			_square1->Write(2, value);
			break;
		case 0x64:
			_square1->Write(3, value);
			break;
		case 0x65:
			_square1->Write(4, value);
			break;
		case 0x66:
			break;
		case 0x67:
		...
		case 0x68:
			_square2->Write(1, value);
			break;
		case 0x69:
			_square2->Write(2, value);
			break;
		case 0x6A:
			break;
		case 0x6B:
			break;
		case 0x6C:
			_square2->Write(3, value);
			break;
		case 0x6D:
			_square2->Write(4, value);
			break;
		case 0x6E:
			break;
		case 0x6F:
		...
		case 0x78:
			_noise->Write(1, value);
			break;
		case 0x79:
			_noise->Write(2, value);
			break;
		case 0x7A:
			break;
		case 0x7B:
			break;
		case 0x7C:
			_noise->Write(3, value);
			break;
		case 0x7D:
			_noise->Write(4, value);
			break;
		case 0x7E:
			break;
		case 0x7F:
