...
void SnesCpu::RunOp() {
	switch (GetOpCode()) {
		...
		case 0x1C:
			...
			break;
		case 0x1D:
			AddrMode_AbsIdxX(false);
			ORA();
			break;
		case 0x1E:
			AddrMode_AbsIdxX(true);
			ASL();
			break;
		case 0x1F:
			AddrMode_AbsLngIdxX();
