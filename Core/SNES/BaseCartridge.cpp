...
CoprocessorType BaseCartridge::GetCoprocessorType() {
	if ((_cartInfo.RomType & 0x0F) >= 0x03) {
		switch ((_cartInfo.RomType & 0xF0) >> 4) {
			...
			case 0x01:
				return CoprocessorType::GSU;
			case 0x02:
				return CoprocessorType::OBC1;
			case 0x03:
				return CoprocessorType::SA1;
			case 0x04:
				return CoprocessorType::SDD1;
			case 0x05:
				return CoprocessorType::RTC;
			case 0x0E:
				switch (_cartInfo.RomType) {
					case 0xE3:
						return CoprocessorType::SGB;
					case 0xE5:
						return CoprocessorType::Satellaview;
					default:
...
void BaseCartridge::DisplayCartInfo(bool showCorruptedHeaderWarning) {
	...
	if (_coprocessorType != CoprocessorType::None) {
		...
		switch (_coprocessorType) {
			case CoprocessorType::None:
				coProcMessage += "<none>";
				break;
			case CoprocessorType::CX4:
				coProcMessage += "CX4";
				break;
			case CoprocessorType::SDD1:
				coProcMessage += "S-DD1";
				break;
			...
			case CoprocessorType::GSU:
				...
				break;
			case CoprocessorType::OBC1:
				coProcMessage += "OBC1";
				break;
			case CoprocessorType::RTC:
				coProcMessage += "RTC";
				break;
			case CoprocessorType::SA1:
				coProcMessage += "SA1";
				break;
			case CoprocessorType::Satellaview:
				coProcMessage += "Satellaview";
				break;
			case CoprocessorType::SPC7110:
				coProcMessage += "SPC7110";
				break;
			...
			case CoprocessorType::ST011:
				coProcMessage += "ST011";
				break;
			case CoprocessorType::ST018:
				coProcMessage += "ST018";
				break;
			case CoprocessorType::SGB:
				coProcMessage += "Super Game Boy";
				break;
		}
