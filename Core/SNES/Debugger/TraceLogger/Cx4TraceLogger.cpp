...
void Cx4TraceLogger::GetTraceRow(string& output, Cx4State& cpuState, TraceLogPpuState& ppuState, DisassemblyInfo& disassemblyInfo) {
	for (RowPart& rowPart : _rowParts) {
		switch (rowPart.DataType) {
			...
			case RowDataType::R0:
				WriteIntValue(output, cpuState.Regs[0], rowPart);
				break;
			case RowDataType::R1:
				WriteIntValue(output, cpuState.Regs[1], rowPart);
				break;
			case RowDataType::R2:
				WriteIntValue(output, cpuState.Regs[2], rowPart);
				break;
			case RowDataType::R3:
				WriteIntValue(output, cpuState.Regs[3], rowPart);
				break;
			case RowDataType::R4:
				WriteIntValue(output, cpuState.Regs[4], rowPart);
				break;
			case RowDataType::R5:
				WriteIntValue(output, cpuState.Regs[5], rowPart);
				break;
			case RowDataType::R6:
				WriteIntValue(output, cpuState.Regs[6], rowPart);
				break;
			case RowDataType::R7:
				WriteIntValue(output, cpuState.Regs[7], rowPart);
				break;
			case RowDataType::R8:
				WriteIntValue(output, cpuState.Regs[8], rowPart);
				break;
			case RowDataType::R9:
				WriteIntValue(output, cpuState.Regs[9], rowPart);
				break;
			case RowDataType::R10:
				WriteIntValue(output, cpuState.Regs[10], rowPart);
				break;
			case RowDataType::R11:
				WriteIntValue(output, cpuState.Regs[11], rowPart);
				break;
			case RowDataType::R12:
				WriteIntValue(output, cpuState.Regs[12], rowPart);
				break;
			case RowDataType::R13:
				WriteIntValue(output, cpuState.Regs[13], rowPart);
				break;
			case RowDataType::R14:
				WriteIntValue(output, cpuState.Regs[14], rowPart);
				break;
			case RowDataType::R15:
				WriteIntValue(output, cpuState.Regs[15], rowPart);
				break;

			case RowDataType::MAR:
				WriteIntValue(output, cpuState.MemoryAddressReg, rowPart);
				break;
			case RowDataType::MDR:
				WriteIntValue(output, cpuState.MemoryDataReg, rowPart);
				break;
			case RowDataType::DPR:
				WriteIntValue(output, cpuState.DataPointerReg, rowPart);
				break;
			case RowDataType::ML:
				WriteIntValue(output, (uint32_t)(cpuState.Mult & 0xFFFFFF), rowPart);
				break;
			case RowDataType::MH:
				WriteIntValue(output, (uint32_t)(cpuState.Mult >> 24), rowPart);
				break;

			case RowDataType::PB:
				WriteIntValue(output, cpuState.PB, rowPart);
				break;
			case RowDataType::P:
				WriteIntValue(output, cpuState.P, rowPart);
				break;
