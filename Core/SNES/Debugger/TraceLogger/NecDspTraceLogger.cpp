	...
	for (RowPart& rowPart : _rowParts) {
		switch (rowPart.DataType) {
			case RowDataType::A:
				...
				break;
			case RowDataType::FlagsA:
				WriteAccFlagsValue(output, cpuState.FlagsA, rowPart);
				break;
			case RowDataType::B:
				WriteIntValue(output, cpuState.B, rowPart);
				break;
			case RowDataType::FlagsB:
				WriteAccFlagsValue(output, cpuState.FlagsB, rowPart);
				break;
			case RowDataType::K:
				WriteIntValue(output, cpuState.K, rowPart);
				break;
			case RowDataType::L:
				WriteIntValue(output, cpuState.L, rowPart);
				break;
			case RowDataType::M:
				WriteIntValue(output, cpuState.M, rowPart);
				break;
			case RowDataType::N:
				WriteIntValue(output, cpuState.N, rowPart);
				break;
			case RowDataType::RP:
				WriteIntValue(output, cpuState.RP, rowPart);
				break;
			case RowDataType::DP:
				WriteIntValue(output, cpuState.DP, rowPart);
				break;
			case RowDataType::DR:
				WriteIntValue(output, cpuState.DR, rowPart);
				break;
			case RowDataType::SR:
				WriteIntValue(output, cpuState.SR, rowPart);
				break;
			case RowDataType::TR:
				WriteIntValue(output, cpuState.TR, rowPart);
				break;
			case RowDataType::TRB:
				WriteIntValue(output, cpuState.TRB, rowPart);
				break;
